...
![Top Artists by Age](/img/top-artist-age.png)

### Top Artist and Song Plays for User 3

![Top songs user 3](/img/user3-top-songs08.png) ![Top arists user 3](/img/user3-top-artists08.png)
...
![Lin Reg](/img/Top10_LR_artist.png)
...
![Poly Reg Scores](/img/Top10_PR_artist.png)
...
![Ridge R2](/img/Top10_ridgeR_artist.png)
...
![Lasso R2](/img/Top10_lassoR_artist.png)
...
![RF Scores](/img/Top10_RF_artist.png)
...
{: .box-note}
**Regardless of these outcomes, I am firm in my belief that an advertisement structure for a radio must be much more than playing an advertisement every certain number of songs. On a radio platform like Last.fm or Pandora, user retention, i.e. listening session time maximization, is cruicial for revenue generation and overall company strength.**
